...
import com.lyricalvideostatusmaker.lyricalphotovideomaker.lyricalvideomaker.dialog.DialogDownloadRingToneSet;
...
public class RingtoneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdMobLoadAds.getInstance().loadBanner(RingtoneActivity.this, creation_banner);
    ...
    public void permission() {
        if (ContextCompat.checkSelfPermission(context, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            ActivityCompat.requestPermissions(RingtoneActivity.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE},
                    1);
        } else {
            loadSongs();
        }
    ...
    public void setTabView() {
        ...
        albumAdapter = new AlbumAdapter(RingtoneActivity.this, categoryArrayList);
    ...
    public void setRecycle(int cId) {
        ...
        songsAdapter = new SongsAdapter(RingtoneActivity.this, songsArrayList);
    ...
    public class SongsAdapter extends RecyclerView.Adapter<SongsAdapter.Holder> {
        ...
        public void onBindViewHolder(@NonNull final Holder holder, final int i) {
            ...
            if (manager.checkthemesongurl(themeModel.Id, themeModel.SoundFile)) {
                Glide.with(context).load(R.drawable.song_set_button).apply(new RequestOptions().fitCenter()).into(holder.use);
            } else {
            ...
            holder.use.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        current_sound = themeModel.Theme_Name.replaceAll("'", "''");
                                ...
                                if (checkSystemWritePermission()) {
                                    AdMobLoadAds.getInstance().displayInterstitial(getApplicationContext(), new AdMobLoadAds.MyCallback() {
                                        ...
                                        public void callbackCall() {
                                            ...
                                            DialogDownloadRingToneSet downloadDialog = new DialogDownloadRingToneSet(context, themeModel.SoundFile);
                                                    ...
                                                    try {
                                                        ...
                                                        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP_MR1) {
                                                            ...
                                                            try {
                                                                ...
                                                                Toast.makeText(getApplicationContext(), "Unable to set as Ringtone ", Toast.LENGTH_SHORT).show();
                                                            }
                        ...
                        public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                            try {
                                ...
                                if (manager.checktheme(theme.Id)) {
                                    Glide.with(context).load(R.drawable.song_set_button).apply(new RequestOptions().fitCenter()).into(viewHolder.use);
                                } else {
                                    Glide.with(context).load(R.drawable.download).apply(new RequestOptions().fitCenter()).into(viewHolder.use);
                                }

                                asyntaskCount.add(new HttpPostRequestCountSongs(theme.Id).execute(Constants. + "downloadRingtone/formate/json/"));
