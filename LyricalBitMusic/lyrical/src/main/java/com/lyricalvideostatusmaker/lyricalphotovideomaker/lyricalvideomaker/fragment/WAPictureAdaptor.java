...
public class WAPictureAdaptor extends Adapter<WAPictureAdaptor.MyViewHolder> {
    ...
    public WAPictureAdaptor(Context context, ArrayList<ModelStatus> arrayList2) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new MyViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_wa_pictures, viewGroup, false));
    }
        ...
        public MyViewHolder(View view) {
            ...
            btn_download.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ModelStatus modelStatus = (ModelStatus) arrayList.get(MyViewHolder.this.getAdapterPosition());
                    String str = "";
