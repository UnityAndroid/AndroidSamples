...
public class WAPictureFragment extends Fragment implements OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.fragment_wa_status_pics, viewGroup, false);
            ...
            new AsyncTask<Void, Void, Void>() {
                ...
                public void onPostExecute(Void voidR) {
                    ...
                    if (data.toArray().length == 0) {
                        ...
                        rv.setAdapter(new WAPictureAdaptor(getActivity(), data));
