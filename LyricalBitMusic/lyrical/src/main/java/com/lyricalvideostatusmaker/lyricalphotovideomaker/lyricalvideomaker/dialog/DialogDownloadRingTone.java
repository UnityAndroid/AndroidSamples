...
public class DialogDownloadRingTone extends Dialog {

    private static final String TAG = DialogDownloadRingTone.class.getSimpleName();
    Context context;
    int id, catid;
    ...
    public DialogDownloadRingTone(Context context, int id, String soundUrl, int catid, String lyrics) {
        super(context);
    ...
    private class DownloadSongTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(final String result) {
            if (!result.equalsIgnoreCase("-1")) {
                ...
                new HttpPostRequestCountSongs(id).execute(Constants. + "downloadRingtone/formate/json/");
