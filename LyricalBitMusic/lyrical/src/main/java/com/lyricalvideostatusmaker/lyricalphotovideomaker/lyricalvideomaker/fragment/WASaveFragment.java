...
public class WASaveFragment extends Fragment implements OnRefreshListener {
            ...
            new AsyncTask<Void, Void, Void>() {
                ...
                public Void doInBackground(Void... voidArr) {
                    for (int i = 0; i < listFiles.length; i++) {
                        if (listFiles[i].getName().endsWith(".jpg") || listFiles[i].getName().endsWith("gif") || listFiles[i].getName().endsWith(".mp4")) {
                            ...
                            sb3.append(Config.WhatsAppSaveStatus);
                ...
                public void onPostExecute(Void voidR) {
                    ...
                    if (data.toArray().length == 0) {
                        ...
                        rv.setAdapter(new WASavedAdaptor(getActivity(), data));
