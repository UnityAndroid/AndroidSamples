...
}else if(isset($_POST['id']))
{
  if(isset($_FILES['Sound']))
  {
   ...
   $Icon_url="http://$_SERVER[HTTP_HOST]"."/lyrically/Sounds/".$name;
...
{
 mysqli_query($con,"update sounds set lyrics='".$_POST['lyrics']."' where id=".$_POST['id']."");
}
}
else if(isset($_POST['sound_name']))
{
  ...
  mysqli_query($con,"insert into sounds values(0,".$category_id.",'".$sound_name."','".$Icon_path."','".$Icon_url."','".$len."',0,".$pos.",'".$lyrics."')");
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top" onload="get_custom_data('save_sound','show_sound',0,'',0,'<?php echo $_SESSION["category_id"]; ?>');">
  <div class="container-fluid" >
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="form-group">
        <label for="exampleInputEmail1">Lyrics</label>
        <?php
        if(isset($_REQUEST['uid']))
        {
         ...
         <input class="form-control" id="exampleInputEmail1" type="text" value="<?php  echo $main['lyrics']; ?>" aria-describedby="emailHelp"  name="lyrics" placeholder="Enter Lyrics">
       ...
       {
        ?>
        <input class="form-control" id="exampleInputEmail1" type="text" aria-describedby="emailHelp" name="lyrics" required="" placeholder="Enter Lyrics">
