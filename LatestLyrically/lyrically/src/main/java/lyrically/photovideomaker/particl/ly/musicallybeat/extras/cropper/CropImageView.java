...
package lyrically.photovideomaker.particl.ly.musicallybeat.extras.cropper;
...
import com.picshow.slideshow.videomaker.R;
...
public class CropImageView extends FrameLayout {
    ...
    private OnSetImageBitmapCompleteListener mOnSetImageBitmapCompleteListener;
    /**
    ...
    public void setmOnSetImageBitmapCompleteListener(OnSetImageBitmapCompleteListener mOnSetImageBitmapCompleteListener) {
        this.mOnSetImageBitmapCompleteListener = mOnSetImageBitmapCompleteListener;
    }
    ...
    void onSetImageBitmapAsyncComplete(BitmapLoadingWorkerTask.Result result) {
    ...
    private void setBitmap(Bitmap bitmap, int imageResource, Uri imageUri, int loadSampleSize, int degreesRotated) {
        try {
            ...
            OnSetImageBitmapCompleteListener listener = mOnSetImageBitmapCompleteListener;
            if (listener != null) {
                listener.onSetImageUriComplete(this, bitmap, null);
            }
        }catch (Exception e)
        {
            OnSetImageBitmapCompleteListener listener = mOnSetImageBitmapCompleteListener;
            if (listener != null) {
                listener.onSetImageUriComplete(this, bitmap, e);
            }
        }
    ...
    public interface OnSetImageBitmapCompleteListener {
