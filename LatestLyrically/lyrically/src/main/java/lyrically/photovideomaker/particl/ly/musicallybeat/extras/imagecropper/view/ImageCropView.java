...
package lyrically.photovideomaker.particl.ly.musicallybeat.extras.imagecropper.view;
...
import lyrically.photovideomaker.particl.ly.musicallybeat.extras.imagecropper.model.CropInfo;
import lyrically.photovideomaker.particl.ly.musicallybeat.extras.imagecropper.model.ViewState;
import lyrically.photovideomaker.particl.ly.musicallybeat.extras.imagecropper.util.BitmapLoadUtils;
import lyrically.photovideomaker.particl.ly.musicallybeat.extras.imagecropper.view.graphics.FastBitmapDrawable;
...
public class ImageCropView extends AppCompatImageView {
    ...
    public Bitmap getCroppedImage() {
       ...
       /* if (DEFAULT_ASPECT_RATIO_WIDTH == 1 && DEFAULT_ASPECT_RATIO_HEIGHT == 1) {
            assert bitmap != null;
            bitmap = Bitmap.createScaledBitmap(bitmap, ScreenUtils.nImgWidth, ScreenUtils.nImgHeight, false);
        } else if (DEFAULT_ASPECT_RATIO_WIDTH == 9 && DEFAULT_ASPECT_RATIO_HEIGHT == 16)
            bitmap = Bitmap.createScaledBitmap(bitmap, ScreenUtils.imgWidth, ScreenUtils.imgHeight, false);
        else if (DEFAULT_ASPECT_RATIO_WIDTH == 16 && DEFAULT_ASPECT_RATIO_HEIGHT == 9)
            bitmap = Bitmap.createScaledBitmap(bitmap, ScreenUtils.imgHeight, ScreenUtils.imgWidth, false);
      */
