 ...
 import com.positive.mbit.intel.domain.IMediaExtractor;
   ...
   implements IMediaExtractor
 {
   ...
   private com.positive.mbit.intel.Uri uri;
   ...
   public void setDataSource(Context context, com.positive.mbit.intel.Uri uri) throws IOException {
   ...
   public com.positive.mbit.intel.domain.MediaFormat getTrackFormat(int index)
   {
   ...
   public com.positive.mbit.intel.Uri getUri() {
     return this.uri;
   }
 }

/* Location:           E:\SouceCode\recordGame\gdxDemo\libs\android-1.2.2415.jar
 * Qualified Name:     com.positive.mbit.intel.android.MediaExtractorPlugin
