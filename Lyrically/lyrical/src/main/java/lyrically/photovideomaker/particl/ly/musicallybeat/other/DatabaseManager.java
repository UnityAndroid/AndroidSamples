...
public class DatabaseManager extends SQLiteOpenHelper {
    ...
    private final static String DATABASE_NAME = "LyricallyBeat";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS songcategory(Id INTEGER,Cat_Name TEXT,page INTEGER)");
        db.execSQL("CREATE TABLE IF NOT EXISTS song(id INTEGER,Cat_Id INTEGER,sound_name TEXT,sound_url TEXT,sound_full_url TEXT,sound_size TEXT,lyrics TEXT)");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS songdownloads(id INTEGER,sound TEXT,url TEXT,catid INTEGER,lyrics TEXT)");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS bitparticle(id INTEGER,category_id INTEGER,theme_name TEXT,prefab_name TEXT,theme_url TEXT,thumb_url TEXT,particle_url TEXT,is_lock INTEGER)");
        db.execSQL("CREATE TABLE IF NOT EXISTS bitparticledownloads(id INTEGER,category_id INTEGER,theme_name TEXT,prefab_name TEXT,thumb TEXT,particle TEXT,thumb_url TEXT,particle_url TEXT)");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS apps(id INTEGER,name TEXT,url TEXT,logo TEXT,status INTEGER)");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS songcategory");
        ...
        db.execSQL("DROP TABLE IF EXISTS bitparticle");
    ...
    public void insertSONGcatagorytable(int Id, String Cat_Name, int page) {
        checkdb();
        db.execSQL("insert into songcategory values(" + Id + ",'" + Cat_Name + "'," + page + ")");
    }
    ...
    public void insertsong(int id, int Cat_Id, String sound_name, String sound_url, String sound_full_url, String sound_size, String lyrics) {
        checkdb();
        db.execSQL("insert into song VALUES(" + id + "," + Cat_Id + ",'" + sound_name + "','" + sound_url + "','" + sound_full_url + "','" + sound_size + "','" + lyrics + "')");
    }
    ...
    public void insertsongdownloads(int id, String sound, String url, int catid, String lyrics) {
        checkdb();
        db.execSQL("delete from songdownloads where id =" + id);
        db.execSQL("insert into songdownloads values(" + id + ",'" + sound + "','" + url + "'," + catid + ",'" + lyrics + "')");
    }
    ...
    public void insertbitparticledownloads(int themeid, int cat_id, String theme_name, String prefab_name, String thumb, String particle, String turl, String purl) {
        checkdb();
        db.execSQL("delete from bitparticledownloads where id=" + themeid);
        db.execSQL("insert into bitparticledownloads values(" + themeid + "," + cat_id + ",'" + theme_name + "','" + prefab_name + "','" + thumb + "','" + particle + "','" + turl + "','" + purl + "')");
    }
    ...
    public void insertbitparticle(int id, int Cat_Id, String theme_name, String prefab_name, String theme_url, String thumb_url, String particle_url, int is_lock) {
        checkdb();
        db.execSQL("insert into bitparticle VALUES(" + id + "," + Cat_Id + ",'" + theme_name + "','" + prefab_name + "','" + theme_url + "','" + thumb_url + "','" + particle_url + "'," + is_lock + ")");
    }


    public void insertAPPS(int id, String name, String url, String logo, int status) {
        checkdb();
        db.execSQL("insert into apps values(" + id + ",'" + name + "','" + url + "','" + logo + "'," + status + ")");
    }
    ...
    public void removebitparticletable() {
        checkdb();
        db.execSQL("delete from bitparticle");
    }
    ...
    public void updatebitParticleThumbnailDownload(int id, String imgPath) {
        checkdb();
        db.execSQL("update bitparticledownloads set thumb='" + imgPath + "',particle_url='' where id=" + id);
    }
    ...
    public Cursor featchSongByUrl(String url) {
        checkdb();
        return db.rawQuery("select * from song where sound_url like '" + url + "'", null);
    }

    public Cursor getapps() {
        checkdb();
        return db.rawQuery("select * from apps", null);
    }

    public Cursor featchSongCatagarytable() {
        checkdb();
        return db.rawQuery("select * from songcategory", null);
    }

    public Cursor featchSongtable(int Cat_Id) {
        checkdb();
        return db.rawQuery("select * from song where Cat_Id=" + Cat_Id, null);
    }
    ...
    public Cursor featchbitParticletable() {
        checkdb();
        return db.rawQuery("select * from bitparticle", null);
    }
    ...
    public Cursor featchbitParticleById(int id) {
        checkdb();
        return db.rawQuery("select * from bitparticle where id =" + id, null);
    }
    ...
    public Cursor getThemes() {
        checkdb();
        return db.rawQuery("SELECT * FROM theme", null);
    }
    ...
    public Cursor getdownloadedbitparticlebyid(int catid) {
        checkdb();
        return db.rawQuery("select * from bitparticledownloads where id=" + catid, null);
    }
    ...
    public Cursor getdownloadedsoundfromurl(String url) {
        checkdb();
        return db.rawQuery("select * from songdownloads where url like '" + url + "'", null);
    }
    ...
    public boolean checksongurl(String url) {
        checkdb();
        boolean check = false;
        Cursor cursor = null;
        try {
            cursor = db.rawQuery("select * from songdownloads where url like '" + url + "'", null);
            if (cursor.moveToFirst()) {
                check = true;
            } else {
                check = false;
    ...
    public Integer getGoogleAdStatus() {
        checkdb();
        int check = 1;
        Cursor data = db.rawQuery("select * from ads", null);
        if (data.moveToFirst()) {
            check = data.getInt(data.getColumnIndex("gstatus"));
        } else {
            check = 0;
        }
        if (data != null)
    ...
    public Integer getFacebookAdStatus() {
        checkdb();
        int check = 1;
        Cursor data = db.rawQuery("select * from ads", null);
        if (data.moveToFirst()) {
            check = data.getInt(data.getColumnIndex("fstatus"));
        } else {
            check = 0;
        }
        if (data != null)
    ...
    public String getGoogleBanner() {
        ...
        Cursor data = db.rawQuery("select * from ads", null);
        if (data.moveToFirst()) {
            check = data.getString(data.getColumnIndex("banner"));
        } else {
            check = "";
        }
        if (data != null)
    ...
    public String getGoogleInter() {
        ...
        Cursor data = db.rawQuery("select * from ads", null);
        if (data.moveToFirst()) {
            check = data.getString(data.getColumnIndex("inter"));
        } else {
            check = "";
        }
        if (data != null)
    ...
    public String getGoogleNative() {
        ...
        Cursor data = db.rawQuery("select * from ads", null);
        if (data.moveToFirst()) {
            check = data.getString(data.getColumnIndex("gnative"));
        } else {
            check = "";
        }
        if (data != null)
    ...
    public String getFBanner() {
        ...
        Cursor data = db.rawQuery("select * from ads", null);
        if (data.moveToFirst()) {
            check = data.getString(data.getColumnIndex("fbanner"));
        } else {
            check = "";
        }
        if (data != null)
    ...
    public String getFInter() {
        ...
        Cursor data = db.rawQuery("select * from ads", null);
        if (data.moveToFirst()) {
            check = data.getString(data.getColumnIndex("finter"));
        } else {
            check = "";
        }
        if (data != null)
    ...
    public String getFNative() {
        ...
        Cursor data = db.rawQuery("select * from ads", null);
        if (data.moveToFirst()) {
            check = data.getString(data.getColumnIndex("fnative"));
        } else {
            check = "";
        }
        if (data != null)
