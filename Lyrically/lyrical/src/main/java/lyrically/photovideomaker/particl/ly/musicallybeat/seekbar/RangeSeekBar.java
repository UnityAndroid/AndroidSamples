package lyrically.photovideomaker.particl.ly.musicallybeat.seekbar;
...
public class RangeSeekBar extends View {
    ...
    public RectF progressDefaultDstRect = new RectF();
    public RectF progressDstRect = new RectF();
    public Rect progressSrcRect = new Rect();
    public  RectF stepDivRect = new RectF();
    public Rect tickMarkTextRect = new Rect();
    ...
    protected void onMeasureProgress(int w, int h) {
        ...
        if (gravity == Gravity.TOP) {
            ...
            if (leftSB.getIndicatorShowMode() != SeekBar.INDICATOR_ALWAYS_HIDE
                    || rightSB.getIndicatorShowMode() != SeekBar.INDICATOR_ALWAYS_HIDE) {
    ...
    protected void onDrawSeekBar(Canvas canvas) {
        //draw left SeekBar
        if (leftSB.getIndicatorShowMode() == SeekBar.INDICATOR_ALWAYS_SHOW) {
            leftSB.setShowIndicatorEnable(true);
        }
        leftSB.draw(canvas);
        //draw right SeekBar
        if (seekBarMode == SEEKBAR_MODE_RANGE) {
            if (rightSB.getIndicatorShowMode() == SeekBar.INDICATOR_ALWAYS_SHOW) {
    ...
    /**
     * if is single mode, please usee it to get the SeekBar
     *
